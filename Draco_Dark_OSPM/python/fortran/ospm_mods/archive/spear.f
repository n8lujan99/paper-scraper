...
C
C=============================================================================D
      SUBROUTINE spear(Cm,S,dS,ddS,rcond,negweights,apfac2)
      INCLUDE 'moddefs.h'
...
C---- calculate matrix Am
      ...
      call dgemm('N', 'N', Narr, Narr, ilast, 1.d0, Cm, lda,
     &     Cma, lds, 0.d0, Am, lda)
...
c            xtmp=Cma(j,i2)
c            do i1=1,Narr
c               Am(i1,i2)=Am(i1,i2)+Cm(i1,j)*xtmp
c            enddo
c         enddo
c      enddo
