      ...
      real rpl2(nmax),rzl2(nmax),rpl(nmax),rzl(nmax)
      real deco(nmax),decl(nmax),red(1000),znorm(1000)
      character a5*20,a6*20,a26*20,a29*20,a30*20,a31*20,a32*20
      character a33*20,a34*20,a35*20,a36*20,a37*20,a39*20
      external func,func2
      ...
      xbin=3.
      open(unit=1,file='cuts.1',status='old')
      read(1,*) racen
 ...
 668  continue
      ...
      open(unit=1,file='jall',status='old')
      n=0
      nl=0
      do iall=1,1000000
         ...
         xcplae=0.
         xrplae=0.
c         if(xrplae.lt.p1o.and.xcplae.lt.p2o.and.
c     $        dec.gt.d1o.and.dec.lt.d2o.and.sn.gt.sno) then
         if(xrplae.lt.p1o.and.xcplae.lt.p2o.and.sn.gt.sno) then
c            z=(wave/3727.)-1.
         ...
         if(xrplae.gt.p1l.and.xcplae.gt.p2l.and.sn.gt.snl) then
c            z=(wave/1215.)-1.
            call cosmoc(z,degtoMpc,dist)
            roff=degtoMpc*(ra-racen)*cos(dec/57.3)
            nl=nl+1
...
c            call pgpt(nl2,xpl2,ypl2,17)
         ...
         print *,n2,nl2,n2tot
         call pgenv(xmin,xmax,ymin,ymax,0,0)
         call pglabel("Mpc","Mpc","")
c         call pglabel("Mpc","Mpc","The Observable Universe")
         call pgsch(0.3)
