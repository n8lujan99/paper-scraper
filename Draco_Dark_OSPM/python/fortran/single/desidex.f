      ...
      open(unit=1,file='cuts.desi',status='old')
      read(1,*) p1l,p2l,snl,ra0,dec0
      close(1)
      cosd=cos(dec0/57.3)
      diff0=1.58
      ...
      nl=0
      do iall=1,1000000
         read(1,*,end=666) i1,x2,x3,x4,a5,a6,i7,x8,x9,x10,x11,i12,i13,
     $        x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,a26,
     $        i27,i28,i29,a30,x31,a32,a33,a34,a35,a36,a37,x38,a39,
     $        x40,x41,x42,x43,x44,x45,x46,x47,x48,x49
         ...
         xcplae=x49
         xrplae=x45
         diff=sqrt((cosd*(ra-ra0))**2+(dec-dec0)**2)
         if(xrplae.gt.p1l.and.xcplae.gt.p2l.and.sn.gt.snl.and.
     $        diff.lt.diff0) then
            nl=nl+1
            write(11,1101) i1,ra,dec,wave,xflux,sn,xcplae,xrplae,a5
         endif
      enddo
 666  continue
      close(1)
 ...
 1101 format(i10,2(1x,f9.5),1x,f7.2,1x,f7.2,1x,f6.2,2(1x,f7.2),1x,a13)
      end
