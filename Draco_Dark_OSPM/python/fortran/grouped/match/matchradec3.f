...
c      rad=2.0
      ...
      n=0
      do i=1,nmax
         read(1,*,end=666) dx1,dx2,x3,x4,i5
         n=n+1
         dra(n)=dx1
         ddec(n)=dx2
         sb(n)=x3
...
c                  print *,i,j,sn(i),sn(j),imax,iok(i)
      ...
      open(unit=12,file='radec2.out',status='unknown')
      do i=1,n
         if(iok2(i).eq.1) then
            write(11,1011) dra(i),ddec(i),sb(i),sr(i),id(i)
         else
            write(12,1011) dra(i),ddec(i),sb(i),sr(i),id(i)
         endif
      enddo
      close(11)
 888  continue

 1011 format(2(1x,f11.7),2(1x,f14.2),1x,i6)
      end
