...
c- set the normalization value and the 3 background arrays
      ...
      ncback=47
c      cback(1)=
c     $"/scratch/03946/hetdex/lib_calib/back/"//cmth//"sci/"
c      cback(2)=
c     $"/scratch/03946/hetdex/lib_calib/back/"//cmth//"bri/"
c      cback(3)=
c     $"/scratch/03946/hetdex/lib_calib/back/"//cmth//"twi/"
      cback(1)=
     $"/scratch/03946/hetdex/lib_calib/back/100000sci/"
      cback(2)=
     $"/scratch/03946/hetdex/lib_calib/back/100000bri/"
      cback(3)=
     $"/scratch/03946/hetdex/lib_calib/back/100000twi/"
...
c     $     "pixelflat_cam"//cspecid//"_"//cpos//chalf//".fits"
      cspec="/scratch/03946/hetdex/lib_calib/lib_pflat/"//
...
c     $     "_"//cpos//chalf//".fits"
      cspec="/scratch/03946/hetdex/lib_calib/lib_mbias/"
...
c- subtract the master spectrum
     ...
     $     nmaster,wmaster,xmaster,arrs,arrm,xspecs,xspecsm,
     $     ifib,0)
...
c- get fiber profile
     ...
     $        cmth//"/i"//cifupos//"a"//cpos//chalf//"cmbp.fits"
         ...
         file1="/scratch/03946/hetdex/lib_calib/"//cmth
...
c     $     //"virus_config/lib_calib/woff.in",status="old")
      open(unit=3,file=
     $     "/scratch/03946/hetdex/lib_calib/datafiles/woff.in",
     $     status="old")
...
c- get solar and write into ys. Interpolate virus to solar bins into ys2
      open(unit=1,file=
     $     '/scratch/03946/hetdex/lib_calib/datafiles/sun_use.dat',
     $     status='old')
      ns=0
      jin=1
      do i=1,nmax
...
c            jin=jout
      ...
      open(unit=1,
     $     file="/scratch/03946/hetdex/lib_calib/datafiles/ctrap.all",
     $     status='old',err=777)
      do i=1,10000
 ...
 777  continue
      ...
      open(unit=1,
     $file="/scratch/03946/hetdex/lib_calib/datafiles/pdefect.all",
     $     status='old',err=777)
      do iall=1,10000
...
c            call pgsci(1)
     ...
     $     xtrace,ifib,iuse,iplot)
      ...
      parameter (narrm=2000)
      real arr(narrm,narrm),xfib(112),xfiba(1032,112),xoff(5)
...
c- order is, from bottom to top: LU,LL,RL,RU
      ...
      if(cifu.eq."004") then
c         file1="/work/03946/hetdex/maverick/scripts/back/ifu1.txt"
         file1="/scratch/03946/hetdex/lib_calib/datafiles/ifu1.txt"
      else
c         file1="/work/03946/hetdex/maverick/scripts/back/ifu0.txt"
         file1="/scratch/03946/hetdex/lib_calib/datafiles/ifu0.txt"
      endif
