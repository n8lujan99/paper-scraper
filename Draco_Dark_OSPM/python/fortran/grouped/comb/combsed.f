...
c- rmscut is the rms of the difference after normalization
      ...
      open(unit=1,file=
c     $     '/work/03946/hetdex/hdr1/calib/goodsed.dat',
     $     '/work2/00115/gebhardt/hdr/data/goodsed.dat',
     $     status='old')
      do i=1,nmax
...
c remove the last point
 ...
 666  continue
     ...
     $           xballr(i),facapa(i)
            ...
            write(*,1001) i,xballa(i),xballs(i),ibad(i),0.,0.,facapa(i)
c            write(*,1001) i,0.,0.,ibad(i),0.,0.,facapa(i)
