Marked
      ...
      open(unit=3,file='getoff.out',status='unknown')
         
      do i=1,1000
         read(1,*,end=666) dxp1,dyp1,ifu
         do j=1,1000
            read(2,*,end=667) dxp2,dyp2
            dxp1d=(dxp1-dxp2)*3600.d0
            dyp1d=(dyp1-dyp2)*3600.d0
            dradp=dsqrt((dxp1d)**2+(dyp1d)**2)
            if(dradp.lt.drad) then
               write(*,1001) dxp1d,dyp1d,
     $                 dxp1,dyp1,dxp2,dyp2,ifu
               write(3,1001) dxp1d,dyp1d,
     $                 dxp1,dyp1,dxp2,dyp2,ifu
               n12=n12+1
               xa1(n12)=real(dxp1d)
               xa2(n12)=real(dyp1d)
 ...
 666  continue
      ...
      write(*,1002) xba1,xba2,xsa1,xsa2,n12
      cosdec=cos(yp1/57.3)
      write(*,*) "Add these:"
      write(*,1003) -xba1/3600./cosdec,-xba2/3600.
      open(unit=11,file='getoff2.out',status='unknown')
      write(11,1003) -xba1/3600./cosdec,-xba2/3600.,xsa1,xsa2,n12
      close(11)
 1001 format(6(1x,f10.6),1x,i4)
