      ...
      real work(lenw),rsim(nmax),dsim(nmax),zsim(nmax),wsim(nmax)
      real r0(10),d0(10)
...
c         w(n)=1.
 ...
 666  continue
      ...
      open(unit=1,file='sim.in',status='old')

      nsim=0
      do i=1,nmax
         read(1,*,end=667) x1,x2,x3,x4,i5,x6,x7,x8
c         read(1,*,end=667) x1,x2,x3
         nsim=nsim+1
         rsim(nsim)=x1
         dsim(nsim)=x2
         zsim(nsim)=x3/xlya-1.
...
c         jstart=i+1
     ...
     $              neval,ier,limit,lenw,last,iwork,work)
               ...
               rd1=cdec*(r1-r0(iuse))*dm1/206265.*60.*60.
               rd2=cdec*(r(j)-r0(iuse))*dm2/206265.*60.*60.
               dd1=(d1-d0(iuse))*dm1/206265.*60.*60.
