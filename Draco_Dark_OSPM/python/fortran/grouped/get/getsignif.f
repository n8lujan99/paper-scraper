...
c      read *,signsl
 ...
 666  continue
      ...
      open(unit=11,file='signif.out',status='unknown')
      do iall=1,nw
...
c         amp=abs(amp)
 ...
 966  continue
      open(unit=11,file='signif.out',status='unknown')
c      write(11,1101) 0.,0.,0.,0.,0.,0.,0.,0.
      write(11,1101) 0.,0.,0.,0.,0.
      close(11)
 977  continue
c 1101 format(f8.2,1x,f8.2,1x,f10.2,3(1x,f7.2),2(1x,f9.2))
 1101 format(f8.2,1x,f10.2,3(1x,f9.2))
      end
