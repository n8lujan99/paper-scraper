...
c      call pgsci(2)
      call pgsch(1.4)
      call pgptxt(6.5,400.,270.,0.,'Spring Complete')
      call pgptxt(5.8,400.,270.,0.,'Fall Complete')
      call pgsci(1)
      call pgsch(1.5)
      call pgsls(4)
      yl(1)=ymin
...
c      nifud=78
      ...
      do i=2,nadd
         ...
         if(xcheck.gt.2.and.xcheck.lt.3) then
            xcheck=xcheck-2
c            if(icheck2.eq.0) ystart=y(i-1)
            if(icheck2.eq.0) ystart=y(i-1)+38.
         ...
         if(xcheck.gt.3.and.xcheck.lt.4) then
            xcheck=xcheck-3
            if(icheck3.eq.0) ystart=y(i-1)+47.
