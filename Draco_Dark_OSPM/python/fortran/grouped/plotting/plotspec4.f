      ...
      character file1*80,file2*80,c1*18,title*40,cname*15
...
c         read(1,*,end=666) file1
         ...
         cname="comp_6666/mc.in"
         write(cname(6:9),1001) id
c         write(title(12:16),1002) sn
         open(unit=2,file=cname,status='old',err=888)
         read(2,*) x1,x2,x3,x4,x5,x6,x7,x8,x9,x11
         write(title(12:16),1002) x3
         write(title(18:22),1002) x9
         close(2)
...
c     $        'Counts','')
 ...
 555     continue
         call pgsch(2.2)
         call pgmtxt('T',0.8,0.5,0.5,title(1:22))
         call pgsch(1.5)
         call pgsci(1)
 866     continue
         close(2)
