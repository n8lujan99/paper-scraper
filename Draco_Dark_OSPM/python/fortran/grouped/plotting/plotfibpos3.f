      ...
      real wp(1000),gp(10000,100),gpp(10000)
...
c      adc(3)=0.
      ...
      call pgenv(3500.,5500.,0.,0.6,0,0)
      call pgslw(5)
...
c      area=area/0.90
      ...
      do i=1,nw
         wave=wmin+(wmax-wmin)*float(i-1)/float(nw-1)
         wp(i)=wave
         call xlinint(wave,5,wadc,adc,adc0)
