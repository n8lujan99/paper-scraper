      ...
      parameter(nmax=20000,nlmax=1000,nca=17)
...
c            xnoise2=xmaxn*sqrt(float(nerr))
         ...
         print *,'Noise_res, Noise_rms, sigma = ',xnoise2,xnoise,sigg
         print *,'RMS, dAMP, S/N(res,rms) = ',rms,ampe/pixsize,
     $        ston2,ston1
c         ston=ston2
         print *,"xnp, signal, noise, sn ",
     $        nerr,xnp,signal,xnoise2,signal/xnoise2
