...
c- get the throughput curve
         ntp=0
         file1="/scratch/00115/gebhardt/detect/tp/"//
...
c     $        "/work/00115/gebhardt/maverick/detect/tp/tpavg.dat",
     $        "/scratch/03946/hetdex/lib_calib/datafiles/tpavg.dat",
     $        status='old')
         ntp=0
         do i=1,1036
...
c- get the flux correction
         open(unit=1,file=
     $        "/scratch/03946/hetdex/lib_calib/datafiles/fluxcor.use",
     $        status='old')
         nfcor=0
         do i=1,1036
...
c- get the dither file and find the fibers
         file1="/scratch/00115/gebhardt/detect/"//
     ...
     $           (dcos(ddec/57.3d0)*(dx1-dra))**2+(dx2-ddec)**2)
            ...
            if(rads.lt.rad0) then
               ...
               cdith3(ntf)=a3
c- get the multifits               
               file1a(ntf)="/scratch/00115/gebhardt/red1/reductions/"
     $              //cdate//"/virus/virus0000"//cshot//"/"
     $              //a4//"/virus/"//a2(1:20)//".fits"
c- get the amplifier normalization
               file2a(ntf)="/scratch/03946/hetdex/lib_calib/"
     $              //cdate(1:6)//"/i"//a2(11:13)//"a"//a2(19:20)
     $              //"ata.dat"
c- get the chi^2 map
               file3a(ntf)="/scratch/03946/hetdex/lib_calib/reschi"
     $              //"/chi"//a2(7:9)//a2(19:20)//".fits"
c- get the residual map
               file4a(ntf)="/scratch/03946/hetdex/lib_calib/reschi"
     $              //"/res"//a2(7:9)//a2(19:20)//".fits"
c- get the error ratio map
               file5a(ntf)="/scratch/03946/hetdex/lib_calib/reschi"
     $              //"/rres"//a2(7:9)//a2(19:20)//".fits"
c- get the wave corrections from amp.dat
               file6a(ntf)="/scratch/00115/gebhardt/skysub/output/d"
...
c               print *,il,i,x1,gnw(i)
      ...
      open(unit=9,file='outweight',status='unknown')
...
c               gn=gn0/fadc/gnw(n)
               ...
               write(9,*) il,n,wan(il,i),gn,gn0,fadc,gnw(n)
            enddo
         endif
      enddo
      close(9)
