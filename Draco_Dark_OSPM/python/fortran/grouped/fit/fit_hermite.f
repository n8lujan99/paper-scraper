...
c      call qr2('Wavemin and scale ','fitghsp.def',wavem,scale)
      call qr1('Wavelength to check ','fitghsp.def',wave0)
      call savdef
...
c         if(nt.lt.10) goto 766
         ...
         call pgenv(wlo,wup,ymin,ymax*1.1,0,0)
         call pgline(nt,x,y)
         call pgsch(1.4)
c         call pglabel('Wavelength (um)','photons','')
         ...
         call pgslw(2)
         call pgsch(1.1)
c         call pgptxt(4.26,620.,0.,0.,'z = 5.8549 +- 0.0007')
c         call pgptxt(4.26,400.,0.,0.,'z = 5.8537 +- 0.0003')
         call pgsci(1)
         call pgsls(1)
...
c         ston=amp/fluxerr
         ...
         print *,'S/N, zerr = ',ston,amp,rms,0.95*amp,xnoise
