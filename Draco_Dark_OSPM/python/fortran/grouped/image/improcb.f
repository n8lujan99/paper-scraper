      ...
      character cspecid*3,chalf*1,cpos*1,contid*9,camp*2
...
c      call ftgkys(im1,"SPECID",cspecid,file1,ier)
c      call ftgkys(im1,'CCDPOS',cpos,file1,ier)
c      call ftgkys(im1,'CCDHALF',chalf,file1,ier)
      call ftgkys(im1,'CONTID',contid,file1,ier)
      if(ier.ne.0) contid="S/N 0666"
c      camp=cpos//chalf

      call biwgt(xin,n,xb,xs)
c      print *,'Overscan, Average count is : ',xbo,xb,xs
      open(unit=11,file='out',status='unknown')
      write(11,1101) xbo,xb,xs,contid
      close(11)
 1101 format(3(1x,f10.3),1x,a9)
