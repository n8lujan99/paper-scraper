 ...
 1001 format('Iteration: ',i4,1x,i5,5(1x,f8.4),3x,i4
     $     ,1x,f8.2,1x,f8.2)
      ...
      do i=1,nl+nt+1
         ...
         ylo2=max(0.,yin(i16))
         if(i.le.nl) then
c            write(11,*) xl(i),xb,yin(i5),yin(i16),yin(i84),yin(i95)
            write(11,*) xl(i),xb,ylo1,ylo2,yin(i84),yin(i95)
         else
c            write(11,*) xb,yin(i5),yin(i16),yin(i84),yin(i95)
            write(11,*) xb,ylo1,ylo2,yin(i84),yin(i95)
         endif
      enddo
      close(11)
      close(12)
